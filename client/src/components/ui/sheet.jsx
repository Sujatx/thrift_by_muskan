...
const SheetContent = React.forwardRef(
  ({ side = 'right', className, children, showClose = true, ...props }, ref) => (
    <SheetPortal>
      ...
      >
        {showClose && (
          <SheetPrimitive.Close className="absolute right-4 top-4 z-10 rounded-sm opacity-60 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring">
            <X className="h-4 w-4" />
